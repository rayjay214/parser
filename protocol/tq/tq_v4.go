...
func (entity *TQ_V4) MsgID() MsgID {
	return Msg_V1
}

func (entity *TQ_V4) Encode() ([]byte, error) {
...
func (entity *TQ_V4) Decode(data []byte) (int, error) {
	strData := string(data)
	strList := strings.Split(strData, ",")
	entity.Manu = strings.TrimPrefix(strList[0], "*")
	entity.Imei = strList[1]
	entity.Proto = strList[2]
	entity.Cmd = strList[3]
	if strList[3] == "SMS" {
		entity.Content = strings.TrimSuffix(strList[4], "#")
		return len(data), nil
	}
	entity.CfmTime = strList[4]
	strTime := strList[5]
	entity.Located = strList[6]
	strLat := strList[7]
	strLatFlag := strList[8]
	strLng := strList[9]
	strLngFlag := strList[10]
	strSpeed := strList[11]
	entity.Direction = strList[12]
	strDate := strList[13]
	entity.Status = strList[14]
	entity.Mcc = strList[15]
	entity.Mnc = strList[16]
	entity.Lac = strList[17]
	entity.Cellid = strings.TrimSuffix(strList[18], "#")
...
func (entity TQ_V4) MarshalJSON() ([]byte, error) {
	type Alias TQ_V4
