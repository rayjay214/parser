...
func (entity *TQ_V6) MsgID() MsgID {
	return Msg_V1
}

func (entity *TQ_V6) Encode() ([]byte, error) {
...
func (entity *TQ_V6) Decode(data []byte) (int, error) {
	strData := string(data)
	...
	entity.Cellid = strList[16]
	entity.Iccid = strings.TrimSuffix(strList[17], "#")
...
func (entity TQ_V6) MarshalJSON() ([]byte, error) {
	type Alias TQ_V6
