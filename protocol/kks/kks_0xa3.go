...
func (entity *Kks_0xa3) MsgID() MsgID {
	return Msg_0xa3
}

func (entity *Kks_0xa3) Encode() ([]byte, error) {
...
func (entity *Kks_0xa3) Decode(data []byte) (int, error) {
...
func (entity Kks_0xa3) MarshalJSON() ([]byte, error) {
	type Alias Kks_0xa3
