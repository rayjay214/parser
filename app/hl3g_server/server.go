...
func main() {
	...
	server.AddHandler(hl3g.Msg_STU, handleSTU)
	server.AddHandler(hl3g.Msg_RESET, handleRESET)
	server.AddHandler(hl3g.Msg_FACTORY, handleFACTORY)
	server.AddHandler(hl3g.Msg_UPLOAD, handleUPLOAD)
	server.AddHandler(hl3g.Msg_MODEWORK, handleMODEWORK)
	server.AddHandler(hl3g.Msg_VERNO, handleVERNO)
	server.AddHandler(hl3g.Msg_TC, handleTC)
	server.AddHandler(hl3g.Msg_CLOSEMODE, handleCLOSEMODE)
