...
func (entity *TQ_V5) MsgID() MsgID {
    return Msg_V5
}

func (entity *TQ_V5) Encode() ([]byte, error) {
...
func (entity *TQ_V5) Decode(data []byte) (int, error) {
    strData := string(data)
    ...
    entity.Mile = strings.TrimSuffix(strList[17], "#")
...
func (entity TQ_V5) MarshalJSON() ([]byte, error) {
    type Alias TQ_V5
