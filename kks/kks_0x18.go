...
func (entity *Kks_0x18) MsgID() MsgID {
    return Msg_0x18
}

func (entity *Kks_0x18) Encode() ([]byte, error) {
...
func (entity *Kks_0x18) Decode(data []byte) (int, error) {
...
func (entity Kks_0x18) MarshalJSON() ([]byte, error) {
    type Alias Kks_0x18
